    ...
    if (cmd === "match") {
        ...
        if (currentUser.uid == room["player1-id"] || currentUser.uid == room["player2-id"]){          
            ...
            const countGoToRoom = setInterval(() => {
                findct.innerHTML = '<i class="bi bi-person-bounding-box" style="color: black;"></i><span><b style="margin-left:5px">พบคู่แข่งแล้ว!</b> <br><h5>รอสักครู่ เรากำลังพาคุณไปยังห้องเล่น!</h5></span>'
